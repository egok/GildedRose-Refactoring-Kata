...
public class GildedRoseTest {
    ...
    {
        myRose = new GildedRoseItemsBuilder().name("foo").quality(10).sellIn(2).update();
    ...
    {
        myRose = new GildedRoseItemsBuilder().name("foo").quality(9).sellIn(1).update();
    ...
    {
        myRose = new GildedRoseItemsBuilder().name("foo").quality(8).sellIn(0).update();
    ...
    {
        myRose = new GildedRoseItemsBuilder().name("foo").quality(1).sellIn(0).update();
    ...
    {
        myRose = new GildedRoseItemsBuilder().name("foo").quality(2).sellIn(0).update();
    ...
    {
        myRose = new GildedRoseItemsBuilder().name("foo").quality(0).sellIn(0).update();
    ...
    {
        myRose = new GildedRoseItemsBuilder().name("Aged Brie").quality(8).sellIn(9).update();
    ...
    {
        myRose = new GildedRoseItemsBuilder().name("Aged Brie").quality(50).sellIn(9).update();
    ...
    {
        myRose = new GildedRoseItemsBuilder().name("Sulphurs, Hand of Ragnaros").quality(70).sellIn(0).update();
    ...
    {
        myRose = new GildedRoseItemsBuilder().name("Sulphurs, Hand of Ragnaros").quality(80).sellIn(0).update();
    ...
    {
        myRose = new GildedRoseItemsBuilder().name("Backstage passes to a TAFKAL80ETC concert").quality(10).sellIn(10).update();
    ...
    {
        myRose = new GildedRoseItemsBuilder().name("Backstage passes to a TAFKAL80ETC concert").quality(10).sellIn(5).update();
    ...
    {
        myRose = new GildedRoseItemsBuilder().name("Backstage passes to a TAFKAL80ETC concert").quality(10).sellIn(0).update();
    ...
    {
        myRose = new GildedRoseItemsBuilder().name("Conjured Mana Cake").quality(10).sellIn(10).update();
    ...
    {
        myRose = new GildedRoseItemsBuilder().name("Conjured Mana Cake").quality(10).sellIn(0).update();
